...
export function openAddCoverageModal() {
  window.dispatchEvent(new CustomEvent("sumzero:open-add-coverage"))
}
              ...
              <div className="p-7">
                {success ? (
                  <div className="flex flex-col items-center text-center py-8 gap-4">
                    ...
                    <h3 className="text-xl font-black text-[#1F2535]">Request received.</h3>
